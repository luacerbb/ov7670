...
void OV7670_GPIO_Init(void)
{
  ...
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;//GPIO_Mode_IPU; //GPIO_Mode_IPD;//GPIO_Mode_AF_OD  GPIO_Mode_AF_PP GPIO_Mode_IPU	GPIO_Mode_IN_FLOATING   
  //GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
...
void OV7670_GPIO_CONTRL_CONFIG(void)
{
  ...
  GPIO_InitStructure.GPIO_Pin  = GPIO_Pin_2;    //PD2 PCLK
...
{   
	...
	NVIC_InitTypeDef NVIC_InitStructure;
  	...
  	GPIO_EXTILineConfig(GPIO_PortSourceGPIOD,GPIO_PinSource2);//PD2对中断线8
